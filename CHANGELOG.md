...
* Add `GestureOptions.pinchRotationEnabled` flag to be able to disable map rotation by the pinch gesture. ([#774](https://github.com/mapbox/mapbox-maps-ios/pull/774))
