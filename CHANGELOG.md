...
* Fixed billing issue when upgrading Mapbox Maps SDK from v6 to v10. ([#](https://github.com/mapbox/mapbox-maps-ios/pull/))
...
* Fixed a bug affecting the persistence of user settings when upgrading to v10. ([#762](https://github.com/mapbox/mapbox-maps-ios/pull/762))
