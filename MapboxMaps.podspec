Pod::Spec.new do |m|
  ...
  m.name = 'MapboxMaps'
  m.version = '11.31.0-SNAPSHOT-08-25--01-53.git-9037a0e'
  ...
  m.dependency 'MapboxCoreMaps', '11.31.0-SNAPSHOT-08-25--01-53.git-9037a0e'
  m.dependency 'MapboxCommon', '24.31.0-SNAPSHOT-08-25--01-53.git-9037a0e'
