Pod::Spec.new do |m|
  ...
  m.name = 'MapboxMaps'
  m.version = '11.16.0-SNAPSHOT-08-27--04-29.git-4fc6d5f'
  ...
  m.dependency 'MapboxCoreMaps', '11.16.0-SNAPSHOT-08-27--04-29.git-4fc6d5f'
  m.dependency 'MapboxCommon', '24.16.0-SNAPSHOT-08-27--04-29.git-4fc6d5f'
