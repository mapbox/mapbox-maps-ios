Pod::Spec.new do |m|
  ...
  m.name = 'MapboxMaps'
  m.version = '11.29.0-SNAPSHOT-08-07--12-48.git-47db05d'
  ...
  m.dependency 'MapboxCoreMaps', '11.29.0-SNAPSHOT-08-07--12-48.git-47db05d'
  m.dependency 'MapboxCommon', '24.29.0-SNAPSHOT-08-07--12-48.git-47db05d'
