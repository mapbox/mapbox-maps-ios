Pod::Spec.new do |m|
  ...
  m.name = 'MapboxMaps'
  m.version = '11.17.0-beta.2-SNAPSHOT-11-17--08-06.git-1a8d3cd'
  ...
  m.dependency 'MapboxCoreMaps', '11.17.0-beta.2-SNAPSHOT-11-17--08-06.git-1a8d3cd'
  m.dependency 'MapboxCommon', '24.17.0-beta.2-SNAPSHOT-11-17--08-06.git-1a8d3cd'
