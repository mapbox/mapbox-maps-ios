Pod::Spec.new do |m|
  ...
  m.name = 'MapboxMaps'
  m.version = '11.14.0-SNAPSHOT-06-06--04-30.git-ae7b59c'
  ...
  m.dependency 'MapboxCoreMaps', '11.14.0-SNAPSHOT-06-06--04-30.git-ae7b59c'
  m.dependency 'MapboxCommon', '24.14.0-SNAPSHOT-06-06--04-30.git-ae7b59c'
