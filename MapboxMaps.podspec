Pod::Spec.new do |m|
  ...
  m.name = 'MapboxMaps'
  m.version = '11.15.0-SNAPSHOT-07-17--04-32.git-b7795aa'
  ...
  m.dependency 'MapboxCoreMaps', '11.15.0-SNAPSHOT-07-17--04-32.git-b7795aa'
  m.dependency 'MapboxCommon', '24.15.0-SNAPSHOT-07-17--04-32.git-b7795aa'
