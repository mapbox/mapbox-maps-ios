Pod::Spec.new do |m|
  ...
  m.name = 'MapboxMaps'
  m.version = '11.18.0-SNAPSHOT-11-26--04-30.git-cfe4d7e'
  ...
  m.dependency 'MapboxCoreMaps', '11.18.0-SNAPSHOT-11-26--04-30.git-cfe4d7e'
  m.dependency 'MapboxCommon', '24.18.0-SNAPSHOT-11-26--04-30.git-cfe4d7e'
