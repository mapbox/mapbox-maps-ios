Pod::Spec.new do |m|
  ...
  m.name = 'MapboxMaps'
  m.version = '11.15.0-SNAPSHOT-07-11--04-32.git-8b7e0db'
  ...
  m.dependency 'MapboxCoreMaps', '11.15.0-SNAPSHOT-07-11--04-32.git-8b7e0db'
  m.dependency 'MapboxCommon', '24.15.0-SNAPSHOT-07-11--04-32.git-8b7e0db'
