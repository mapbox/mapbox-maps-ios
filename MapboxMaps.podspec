Pod::Spec.new do |m|
  ...
  m.name = 'MapboxMaps'
  m.version = '11.15.0-SNAPSHOT-08-02--04-31.git-d3e6c6c'
  ...
  m.dependency 'MapboxCoreMaps', '11.15.0-SNAPSHOT-08-02--04-31.git-d3e6c6c'
  m.dependency 'MapboxCommon', '24.15.0-SNAPSHOT-08-02--04-31.git-d3e6c6c'
