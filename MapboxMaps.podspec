Pod::Spec.new do |m|
  ...
  m.name = 'MapboxMaps'
  m.version = '11.13.0-SNAPSHOT-04-09--04-29.git-c0e91ed'
  ...
  m.dependency 'MapboxCoreMaps', '11.13.0-SNAPSHOT-04-09--04-29.git-c0e91ed'
  m.dependency 'MapboxCommon', '24.13.0-SNAPSHOT-04-09--04-29.git-c0e91ed'
