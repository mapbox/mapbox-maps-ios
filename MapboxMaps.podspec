Pod::Spec.new do |m|
  ...
  m.name = 'MapboxMaps'
  m.version = '11.17.0-SNAPSHOT-11-04--04-29.git-d3ae3cc'
  ...
  m.dependency 'MapboxCoreMaps', '11.17.0-SNAPSHOT-11-04--04-29.git-d3ae3cc'
  m.dependency 'MapboxCommon', '24.17.0-SNAPSHOT-11-04--04-29.git-d3ae3cc'
