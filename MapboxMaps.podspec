Pod::Spec.new do |m|
  ...
  m.name = 'MapboxMaps'
  m.version = '11.18.0-SNAPSHOT-11-25--04-30.git-c6ee6a6'
  ...
  m.dependency 'MapboxCoreMaps', '11.18.0-SNAPSHOT-11-25--04-30.git-c6ee6a6'
  m.dependency 'MapboxCommon', '24.18.0-SNAPSHOT-11-25--04-30.git-c6ee6a6'
