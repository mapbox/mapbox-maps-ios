Pod::Spec.new do |m|
  ...
  m.name = 'MapboxMaps'
  m.version = '11.18.0-SNAPSHOT-11-24--04-31.git-e6a18af'
  ...
  m.dependency 'MapboxCoreMaps', '11.18.0-SNAPSHOT-11-24--04-31.git-e6a18af'
  m.dependency 'MapboxCommon', '24.18.0-SNAPSHOT-11-24--04-31.git-e6a18af'
