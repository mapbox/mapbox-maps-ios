Pod::Spec.new do |m|
  ...
  m.name = 'MapboxMaps'
  m.version = '11.13.0-SNAPSHOT-04-10--04-29.git-058b5a0'
  ...
  m.dependency 'MapboxCoreMaps', '11.13.0-SNAPSHOT-04-10--04-29.git-058b5a0'
  m.dependency 'MapboxCommon', '24.13.0-SNAPSHOT-04-10--04-29.git-058b5a0'
