Pod::Spec.new do |m|
  ...
  m.source = { :git => 'https://github.com/mapbox/mapbox-maps-ios-internal.git', :tag => "v#{maps_version}" }
  m.platform = :ios
  m.ios.deployment_target = '11.0'
  m.swift_version = '5.5'

  m.source_files = 'mapbox-maps-ios/Sources/MapboxMaps/**/*.{swift,h}'
  m.resource_bundles = { 'MapboxMapsResources' => ['mapbox-maps-ios/Sources/**/*.{xcassets,strings}', 'mapbox-maps-ios/Sources/MapboxMaps/MapboxMaps.json'] }
