Pod::Spec.new do |m|
  ...
  m.name = 'MapboxMaps'
  m.version = '11.16.0-SNAPSHOT-08-28--04-29.git-b82c42c'
  ...
  m.dependency 'MapboxCoreMaps', '11.16.0-SNAPSHOT-08-28--04-29.git-b82c42c'
  m.dependency 'MapboxCommon', '24.16.0-SNAPSHOT-08-28--04-29.git-b82c42c'
