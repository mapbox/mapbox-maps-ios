Pod::Spec.new do |m|
  ...
  m.name = 'MapboxMaps'
  m.version = '11.17.0-SNAPSHOT-10-15--04-29.git-e8419fa'
  ...
  m.dependency 'MapboxCoreMaps', '11.17.0-SNAPSHOT-10-15--04-29.git-e8419fa'
  m.dependency 'MapboxCommon', '24.17.0-SNAPSHOT-10-15--04-29.git-e8419fa'
