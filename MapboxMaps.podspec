Pod::Spec.new do |m|
  ...
  m.name = 'MapboxMaps'
  m.version = '11.13.0-SNAPSHOT-05-10--04-29.git-651b2a3'
  ...
  m.dependency 'MapboxCoreMaps', '11.13.0-SNAPSHOT-05-10--04-29.git-651b2a3'
  m.dependency 'MapboxCommon', '24.13.0-SNAPSHOT-05-10--04-29.git-651b2a3'
