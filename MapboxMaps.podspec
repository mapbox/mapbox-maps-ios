Pod::Spec.new do |m|
  ...
  m.name = 'MapboxMaps'
  m.version = '11.16.0-SNAPSHOT-09-20--04-28.git-4373b1a'
  ...
  m.dependency 'MapboxCoreMaps', '11.16.0-SNAPSHOT-09-20--04-28.git-4373b1a'
  m.dependency 'MapboxCommon', '24.16.0-SNAPSHOT-09-20--04-28.git-4373b1a'
