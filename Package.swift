...
let package = Package(
    ...
    products: [
        .library(
            ...
            targets: ["MapboxMaps"]),
        .library(
            name: "MapboxMapsFoundation",
            targets: ["MapboxMapsFoundation"]),
    ],
    dependencies: [
        .package(name: "MapboxCoreMaps", url: "git@github.com:mapbox/mapbox-core-maps-ios.git", .exact("10.0.0-beta.11")),
        .package(name: "MapboxMobileEvents", url: "git@github.com:mapbox/mapbox-events-ios.git", from: "0.10.7"),
        .package(name: "Turf", url: "https://github.com/mapbox/turf-swift.git", .branch("main"))
    ],
    targets: [
        .target(
            name: "MapboxMaps",
            dependencies: [
                "Turf",
                "MapboxMapsFoundation",
                "MapboxMapsGestures",
                "MapboxMapsOrnaments",
                "MapboxMapsLocation",
                "MapboxMapsStyle",
                "MapboxMapsAnnotations",
            ],
        ...
        .target(
            ...
            path: "Mapbox/MapboxMapsFoundation"
        ),
        .target(
            name: "MapboxMapsGestures",
            dependencies: [
                "MapboxMobileEvents",
                "MapboxMapsFoundation"
            ],
            path: "Mapbox/MapboxMapsGestures"
        ),
        .target(
            name: "MapboxMapsOrnaments",
            dependencies: ["MapboxMapsFoundation"],
            path: "Mapbox/MapboxMapsOrnaments"
        ),
        .target(
            name: "MapboxMapsLocation",
            dependencies: ["MapboxMapsFoundation", "MapboxMapsStyle"],
            path: "Mapbox/MapboxMapsLocation"
        ),
        .target(
            name: "MapboxMapsStyle",
            dependencies: [
                "MapboxMobileEvents",
                "Turf",
                "MapboxMapsFoundation"
            ],
            path: "Mapbox/MapboxMapsStyle"
        ),
        .target(
            name: "MapboxMapsAnnotations",
            dependencies: [
                "MapboxMobileEvents",
                "MapboxMapsStyle",
                "Turf",
            ],
            path: "Mapbox/MapboxMapsAnnotations"
        )
    ],
