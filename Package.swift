// swift-tools-version:5.3
 ...
 let package = Package(
     ...
     dependencies: [
         .package(name: "MapboxCommon", url: "git@github.com:mapbox/mapbox-common-ios.git", .exact("10.0.0-beta.4")),
         ...
         .package(name: "Turf", url: "https://github.com/mapbox/turf-swift.git", .exact("1.1.0")),
     ],
     targets: [
         .target(
