...
public struct SymbolLayer: Layer {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try nilEncoder.encode(iconColor, forKey: .iconColor, to: &paintContainer)
        try nilEncoder.encode(iconColorTransition, forKey: .iconColorTransition, to: &paintContainer)
        try nilEncoder.encode(iconHaloBlur, forKey: .iconHaloBlur, to: &paintContainer)
        try nilEncoder.encode(iconHaloBlurTransition, forKey: .iconHaloBlurTransition, to: &paintContainer)
        try nilEncoder.encode(iconHaloColor, forKey: .iconHaloColor, to: &paintContainer)
        try nilEncoder.encode(iconHaloColorTransition, forKey: .iconHaloColorTransition, to: &paintContainer)
        try nilEncoder.encode(iconHaloWidth, forKey: .iconHaloWidth, to: &paintContainer)
        try nilEncoder.encode(iconHaloWidthTransition, forKey: .iconHaloWidthTransition, to: &paintContainer)
        try nilEncoder.encode(iconOpacity, forKey: .iconOpacity, to: &paintContainer)
        try nilEncoder.encode(iconOpacityTransition, forKey: .iconOpacityTransition, to: &paintContainer)
        try nilEncoder.encode(iconTranslate, forKey: .iconTranslate, to: &paintContainer)
        try nilEncoder.encode(iconTranslateTransition, forKey: .iconTranslateTransition, to: &paintContainer)
        try nilEncoder.encode(iconTranslateAnchor, forKey: .iconTranslateAnchor, to: &paintContainer)
        try nilEncoder.encode(textColor, forKey: .textColor, to: &paintContainer)
        try nilEncoder.encode(textColorTransition, forKey: .textColorTransition, to: &paintContainer)
        try nilEncoder.encode(textHaloBlur, forKey: .textHaloBlur, to: &paintContainer)
        try nilEncoder.encode(textHaloBlurTransition, forKey: .textHaloBlurTransition, to: &paintContainer)
        try nilEncoder.encode(textHaloColor, forKey: .textHaloColor, to: &paintContainer)
        try nilEncoder.encode(textHaloColorTransition, forKey: .textHaloColorTransition, to: &paintContainer)
        try nilEncoder.encode(textHaloWidth, forKey: .textHaloWidth, to: &paintContainer)
        try nilEncoder.encode(textHaloWidthTransition, forKey: .textHaloWidthTransition, to: &paintContainer)
        try nilEncoder.encode(textOpacity, forKey: .textOpacity, to: &paintContainer)
        try nilEncoder.encode(textOpacityTransition, forKey: .textOpacityTransition, to: &paintContainer)
        try nilEncoder.encode(textTranslate, forKey: .textTranslate, to: &paintContainer)
        try nilEncoder.encode(textTranslateTransition, forKey: .textTranslateTransition, to: &paintContainer)
        try nilEncoder.encode(textTranslateAnchor, forKey: .textTranslateAnchor, to: &paintContainer)

        var layoutContainer = container.nestedContainer(keyedBy: LayoutCodingKeys.self, forKey: .layout)
        try nilEncoder.encode(visibility, forKey: .visibility, to: &layoutContainer)
        try nilEncoder.encode(iconAllowOverlap, forKey: .iconAllowOverlap, to: &layoutContainer)
        try nilEncoder.encode(iconAnchor, forKey: .iconAnchor, to: &layoutContainer)
        try nilEncoder.encode(iconIgnorePlacement, forKey: .iconIgnorePlacement, to: &layoutContainer)
        try nilEncoder.encode(iconImage, forKey: .iconImage, to: &layoutContainer)
        try nilEncoder.encode(iconKeepUpright, forKey: .iconKeepUpright, to: &layoutContainer)
        try nilEncoder.encode(iconOffset, forKey: .iconOffset, to: &layoutContainer)
        try nilEncoder.encode(iconOptional, forKey: .iconOptional, to: &layoutContainer)
        try nilEncoder.encode(iconPadding, forKey: .iconPadding, to: &layoutContainer)
        try nilEncoder.encode(iconPitchAlignment, forKey: .iconPitchAlignment, to: &layoutContainer)
        try nilEncoder.encode(iconRotate, forKey: .iconRotate, to: &layoutContainer)
        try nilEncoder.encode(iconRotationAlignment, forKey: .iconRotationAlignment, to: &layoutContainer)
        try nilEncoder.encode(iconSize, forKey: .iconSize, to: &layoutContainer)
        try nilEncoder.encode(iconTextFit, forKey: .iconTextFit, to: &layoutContainer)
        try nilEncoder.encode(iconTextFitPadding, forKey: .iconTextFitPadding, to: &layoutContainer)
        try nilEncoder.encode(symbolAvoidEdges, forKey: .symbolAvoidEdges, to: &layoutContainer)
        try nilEncoder.encode(symbolPlacement, forKey: .symbolPlacement, to: &layoutContainer)
        try nilEncoder.encode(symbolSortKey, forKey: .symbolSortKey, to: &layoutContainer)
        try nilEncoder.encode(symbolSpacing, forKey: .symbolSpacing, to: &layoutContainer)
        try nilEncoder.encode(symbolZOrder, forKey: .symbolZOrder, to: &layoutContainer)
        try nilEncoder.encode(textAllowOverlap, forKey: .textAllowOverlap, to: &layoutContainer)
        try nilEncoder.encode(textAnchor, forKey: .textAnchor, to: &layoutContainer)
        try nilEncoder.encode(textField, forKey: .textField, to: &layoutContainer)
        try nilEncoder.encode(textFont, forKey: .textFont, to: &layoutContainer)
        try nilEncoder.encode(textIgnorePlacement, forKey: .textIgnorePlacement, to: &layoutContainer)
        try nilEncoder.encode(textJustify, forKey: .textJustify, to: &layoutContainer)
        try nilEncoder.encode(textKeepUpright, forKey: .textKeepUpright, to: &layoutContainer)
        try nilEncoder.encode(textLetterSpacing, forKey: .textLetterSpacing, to: &layoutContainer)
        try nilEncoder.encode(textLineHeight, forKey: .textLineHeight, to: &layoutContainer)
        try nilEncoder.encode(textMaxAngle, forKey: .textMaxAngle, to: &layoutContainer)
        try nilEncoder.encode(textMaxWidth, forKey: .textMaxWidth, to: &layoutContainer)
        try nilEncoder.encode(textOffset, forKey: .textOffset, to: &layoutContainer)
        try nilEncoder.encode(textOptional, forKey: .textOptional, to: &layoutContainer)
        try nilEncoder.encode(textPadding, forKey: .textPadding, to: &layoutContainer)
        try nilEncoder.encode(textPitchAlignment, forKey: .textPitchAlignment, to: &layoutContainer)
        try nilEncoder.encode(textRadialOffset, forKey: .textRadialOffset, to: &layoutContainer)
        try nilEncoder.encode(textRotate, forKey: .textRotate, to: &layoutContainer)
        try nilEncoder.encode(textRotationAlignment, forKey: .textRotationAlignment, to: &layoutContainer)
        try nilEncoder.encode(textSize, forKey: .textSize, to: &layoutContainer)
        try nilEncoder.encode(textTransform, forKey: .textTransform, to: &layoutContainer)
        try nilEncoder.encode(textVariableAnchor, forKey: .textVariableAnchor, to: &layoutContainer)
        try nilEncoder.encode(textWritingMode, forKey: .textWritingMode, to: &layoutContainer)
    }
