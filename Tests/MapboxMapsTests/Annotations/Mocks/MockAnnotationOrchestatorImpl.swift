...
final class MockAnnotationOrchestatorImpl: AnnotationOrchestratorImplProtocol {
    ...
    let makePolygonAnnotationManagerStub = Stub<MakePolygonAnnotationManagerParams, AnnotationManagerInternal>(defaultReturnValue: PolygonAnnotationManager(id: "test", style: MockStyle(), layerPosition: .default, displayLinkCoordinator: MockDisplayLinkCoordinator(), offsetPolygonCalculator: .init(mapboxMap: MockMapboxMap())))
    ...
    let makePolylineAnnotationManagerStub = Stub<MakePolylineAnnotationManagerParams, AnnotationManagerInternal>(defaultReturnValue: PolylineAnnotationManager(id: "test", style: MockStyle(), layerPosition: .default, displayLinkCoordinator: MockDisplayLinkCoordinator(), offsetLineStringCalculator: .init(mapboxMap: MockMapboxMap())))
    ...
    let makeCircleAnnotationManagerStub = Stub<MakeCircleAnnotationManagerParams, AnnotationManagerInternal>(defaultReturnValue: CircleAnnotationManager(id: "test", style: MockStyle(), layerPosition: .default, displayLinkCoordinator: MockDisplayLinkCoordinator(), offsetPointCalculator: .init(mapboxMap: MockMapboxMap())))
