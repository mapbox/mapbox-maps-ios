...
final class SymbolLayerIntegrationTests: MapViewIntegrationTestCase {
    ...
    internal func testWaitForIdle() throws {
        ...
        didFinishLoadingStyle = { mapView in
            ...
            layer.iconColorUseTheme = .testConstantValue()
            layer.iconColorBrightnessMax = Value<Double>.testConstantValue()
            layer.iconColorBrightnessMin = Value<Double>.testConstantValue()
            layer.iconColorContrast = Value<Double>.testConstantValue()
            ...
            layer.iconHaloColorUseTheme = .testConstantValue()
            ...
            layer.occlusionOpacityMode = Value<OcclusionOpacityMode>.testConstantValue()
            ...
            layer.textColorUseTheme = .testConstantValue()
            ...
            layer.textHaloColorUseTheme = .testConstantValue()
