...
final class FillExtrusionLayerTests: XCTestCase {
    ...
    func testEncodingAndDecodingOfPaintProperties() {
       ...
       layer.fillExtrusionPatternCrossFade = Value<Double>.testConstantValue()
       ...
       do {
           ...
           XCTAssertEqual(layer.fillExtrusionCastShadows, Value<Bool>.testConstantValue())
           ...
           XCTAssertEqual(layer.fillExtrusionPatternCrossFade, Value<Double>.testConstantValue())
    ...
    func testSetPropertyValueWithFunction() {
        let layer = FillExtrusionLayer(id: "test-id", source: "source")
            ...
            .fillExtrusionCastShadows(Bool.testConstantValue())
            ...
            .fillExtrusionPatternCrossFade(Double.testConstantValue())
        ...
        XCTAssertEqual(layer.fillExtrusionCastShadows, Value.constant(Bool.testConstantValue()))
        ...
        XCTAssertEqual(layer.fillExtrusionPatternCrossFade, Value.constant(Double.testConstantValue()))
