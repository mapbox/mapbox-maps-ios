...
final class FillExtrusionLayerTests: XCTestCase {
    ...
    func testSetPropertyValueWithFunction() {
        let layer = FillExtrusionLayer(id: "test-id", source: "source")
            ...
            .fillExtrusionEdgeRadius(Value<Double>.testConstantValue())
            .fillExtrusionAmbientOcclusionGroundAttenuation(Value<Double>.testConstantValue())
            .fillExtrusionAmbientOcclusionGroundRadius(Value<Double>.testConstantValue())
            .fillExtrusionAmbientOcclusionIntensity(Value<Double>.testConstantValue())
            .fillExtrusionAmbientOcclusionRadius(Value<Double>.testConstantValue())
            .fillExtrusionAmbientOcclusionWallRadius(Value<Double>.testConstantValue())
            .fillExtrusionBase(Value<Double>.testConstantValue())
            .fillExtrusionColor(Value<StyleColor>.testConstantValue())
            .fillExtrusionCutoffFadeRange(Value<Double>.testConstantValue())
            .fillExtrusionEmissiveStrength(Value<Double>.testConstantValue())
            .fillExtrusionFloodLightColor(Value<StyleColor>.testConstantValue())
            .fillExtrusionFloodLightGroundAttenuation(Value<Double>.testConstantValue())
            .fillExtrusionFloodLightGroundRadius(Value<Double>.testConstantValue())
            .fillExtrusionFloodLightIntensity(Value<Double>.testConstantValue())
            .fillExtrusionFloodLightWallRadius(Value<Double>.testConstantValue())
            .fillExtrusionHeight(Value<Double>.testConstantValue())
            .fillExtrusionOpacity(Value<Double>.testConstantValue())
            .fillExtrusionPattern(Value<ResolvedImage>.testConstantValue())
            .fillExtrusionRoundedRoof(Value<Bool>.testConstantValue())
            .fillExtrusionTranslate(Value<[Double]>.testConstantValue())
            .fillExtrusionTranslateAnchor(Value<FillExtrusionTranslateAnchor>.testConstantValue())
            .fillExtrusionVerticalGradient(Value<Bool>.testConstantValue())
            .fillExtrusionVerticalScale(Value<Double>.testConstantValue())
