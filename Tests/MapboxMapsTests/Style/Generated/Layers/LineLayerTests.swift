...
final class LineLayerTests: XCTestCase {
    ...
    func testEncodingAndDecodingOfLayoutProperties() {
        ...
        do {
            ...
            XCTAssertEqual(layer.lineElevationGroundScale, Value<Double>.testConstantValue())
    ...
    func testEncodingAndDecodingOfPaintProperties() {
       ...
       layer.lineCutoutFadeWidth = Value<Double>.testConstantValue()
       ...
       do {
           ...
           XCTAssertEqual(layer.lineCutoutOpacity, Value<Double>.testConstantValue())
           ...
           XCTAssertEqual(layer.linePatternCrossFade, Value<Double>.testConstantValue())
    ...
    func testSetPropertyValueWithFunction() {
        let layer = LineLayer(id: "test-id", source: "source")
            ...
            .lineElevationGroundScale(Double.testConstantValue())
            ...
            .lineCutoutOpacity(Double.testConstantValue())
            ...
            .linePatternCrossFade(Double.testConstantValue())
        ...
        XCTAssertEqual(layer.lineElevationGroundScale, Value.constant(Double.testConstantValue()))
        ...
        XCTAssertEqual(layer.lineCutoutOpacity, Value.constant(Double.testConstantValue()))
        ...
        XCTAssertEqual(layer.linePatternCrossFade, Value.constant(Double.testConstantValue()))
