...
final class LineLayerTests: XCTestCase {
    ...
    func testEncodingAndDecodingOfPaintProperties() {
       ...
       do {
           ...
           XCTAssertEqual(layer.lineCutoutWidth, Value<Double>.testConstantValue())
    ...
    func testSetPropertyValueWithFunction() {
        let layer = LineLayer(id: "test-id", source: "source")
            ...
            .lineCutoutWidth(Double.testConstantValue())
        ...
        XCTAssertEqual(layer.lineCutoutWidth, Value.constant(Double.testConstantValue()))
