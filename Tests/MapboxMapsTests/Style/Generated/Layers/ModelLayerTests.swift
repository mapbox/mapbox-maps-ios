...
final class ModelLayerTests: XCTestCase {
    ...
    func testEncodingAndDecodingOfPaintProperties() {
       ...
       do {
           ...
           XCTAssertEqual(layer.modelElevationReference, Value<ModelElevationReference>.testConstantValue())
    ...
    func testSetPropertyValueWithFunction() {
        let layer = ModelLayer(id: "test-id", source: "source")
            ...
            .modelElevationReference(ModelElevationReference.testConstantValue())
        ...
        XCTAssertEqual(layer.modelElevationReference, Value.constant(ModelElevationReference.testConstantValue()))
