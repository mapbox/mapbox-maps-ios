...
final class ModelLayerTests: XCTestCase {
    ...
    func testSetPropertyValueWithFunction() {
        let layer = ModelLayer(id: "test-id", source: "source")
            ...
            .modelHeightBasedEmissiveStrengthMultiplier([Double].testConstantValue())
            ...
            .modelTranslation([Double].testConstantValue())
        ...
        XCTAssertEqual(layer.modelHeightBasedEmissiveStrengthMultiplier, Value.constant([Double].testConstantValue()))
        ...
        XCTAssertEqual(layer.modelRotation, Value.constant([Double].testConstantValue()))
        XCTAssertEqual(layer.modelRoughness, Value.constant(Double.testConstantValue()))
        XCTAssertEqual(layer.modelScale, Value.constant([Double].testConstantValue()))
        XCTAssertEqual(layer.modelScaleMode, Value.constant(ModelScaleMode.testConstantValue()))
        XCTAssertEqual(layer.modelTranslation, Value.constant([Double].testConstantValue()))
