...
final class RasterLayerTests: XCTestCase {
    ...
    func testSetPropertyValueWithFunction() {
        let layer = RasterLayer(id: "test-id", source: "source")
            ...
            .rasterColorMix([Double].testConstantValue())
            .rasterColorRange([Double].testConstantValue())
        ...
        XCTAssertEqual(layer.rasterColorMix, Value.constant([Double].testConstantValue()))
        XCTAssertEqual(layer.rasterColorRange, Value.constant([Double].testConstantValue()))
