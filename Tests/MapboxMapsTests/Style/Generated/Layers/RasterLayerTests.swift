...
final class RasterLayerTests: XCTestCase {
    ...
    func testEncodingAndDecodingOfPaintProperties() {
       ...
       layer.rasterColorScale = Value<RasterColorScale>.testConstantValue()
       ...
       do {
           ...
           XCTAssertEqual(layer.rasterColorScale, Value<RasterColorScale>.testConstantValue())
    ...
    func testSetPropertyValueWithFunction() {
        let layer = RasterLayer(id: "test-id", source: "source")
            ...
            .rasterColorScale(RasterColorScale.testConstantValue())
        ...
        XCTAssertEqual(layer.rasterColorScale, Value.constant(RasterColorScale.testConstantValue()))
