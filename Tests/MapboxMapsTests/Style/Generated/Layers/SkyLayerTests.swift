...
final class SkyLayerTests: XCTestCase {
    ...
    func testSetPropertyValueWithFunction() {
        ...
        XCTAssertEqual(layer.skyAtmosphereSun, Value.constant([Double].testConstantValue()))
        ...
        XCTAssertEqual(layer.skyGradientCenter, Value.constant([Double].testConstantValue()))
