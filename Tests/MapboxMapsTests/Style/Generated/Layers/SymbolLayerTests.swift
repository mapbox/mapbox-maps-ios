...
final class SymbolLayerTests: XCTestCase {
    ...
    func testSetPropertyValueWithFunction() {
        let layer = SymbolLayer(id: "test-id", source: "source")
            ...
            .iconAllowOverlap(Value<Bool>.testConstantValue())
            .iconAnchor(Value<IconAnchor>.testConstantValue())
            .iconIgnorePlacement(Value<Bool>.testConstantValue())
            .iconImage(Value<ResolvedImage>.testConstantValue())
            .iconKeepUpright(Value<Bool>.testConstantValue())
            .iconOffset(Value<[Double]>.testConstantValue())
            .iconOptional(Value<Bool>.testConstantValue())
            .iconPadding(Value<Double>.testConstantValue())
            .iconPitchAlignment(Value<IconPitchAlignment>.testConstantValue())
            .iconRotate(Value<Double>.testConstantValue())
            .iconRotationAlignment(Value<IconRotationAlignment>.testConstantValue())
            .iconSize(Value<Double>.testConstantValue())
            .iconTextFit(Value<IconTextFit>.testConstantValue())
            .iconTextFitPadding(Value<[Double]>.testConstantValue())
            .symbolAvoidEdges(Value<Bool>.testConstantValue())
            .symbolPlacement(Value<SymbolPlacement>.testConstantValue())
            .symbolSortKey(Value<Double>.testConstantValue())
            .symbolSpacing(Value<Double>.testConstantValue())
            .symbolZElevate(Value<Bool>.testConstantValue())
            .symbolZOrder(Value<SymbolZOrder>.testConstantValue())
            .textAllowOverlap(Value<Bool>.testConstantValue())
            .textAnchor(Value<TextAnchor>.testConstantValue())
            .textField(Value<String>.testConstantValue())
            .textFont(Value<[String]>.testConstantValue())
            .textIgnorePlacement(Value<Bool>.testConstantValue())
            .textJustify(Value<TextJustify>.testConstantValue())
            .textKeepUpright(Value<Bool>.testConstantValue())
            .textLetterSpacing(Value<Double>.testConstantValue())
            .textLineHeight(Value<Double>.testConstantValue())
            .textMaxAngle(Value<Double>.testConstantValue())
            .textMaxWidth(Value<Double>.testConstantValue())
            .textOffset(Value<[Double]>.testConstantValue())
            .textOptional(Value<Bool>.testConstantValue())
            .textPadding(Value<Double>.testConstantValue())
            .textPitchAlignment(Value<TextPitchAlignment>.testConstantValue())
            .textRadialOffset(Value<Double>.testConstantValue())
            .textRotate(Value<Double>.testConstantValue())
            .textRotationAlignment(Value<TextRotationAlignment>.testConstantValue())
            .textSize(Value<Double>.testConstantValue())
            .textTransform(Value<TextTransform>.testConstantValue())
            ...
            .iconHaloWidth(Value<Double>.testConstantValue())
            .iconImageCrossFade(Value<Double>.testConstantValue())
            .iconOpacity(Value<Double>.testConstantValue())
            .iconTranslate(Value<[Double]>.testConstantValue())
            .iconTranslateAnchor(Value<IconTranslateAnchor>.testConstantValue())
            .textColor(Value<StyleColor>.testConstantValue())
            .textEmissiveStrength(Value<Double>.testConstantValue())
            .textHaloBlur(Value<Double>.testConstantValue())
            .textHaloColor(Value<StyleColor>.testConstantValue())
            .textHaloWidth(Value<Double>.testConstantValue())
            .textOpacity(Value<Double>.testConstantValue())
            .textTranslate(Value<[Double]>.testConstantValue())
            .textTranslateAnchor(Value<TextTranslateAnchor>.testConstantValue())
