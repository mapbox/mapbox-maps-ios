...
final class SymbolLayerTests: XCTestCase {
    ...
    func testEncodingAndDecodingOfLayoutProperties() {
        ...
        layer.iconSizeScaleRange = Value<[Double]>.testConstantValue()
        ...
        layer.textSizeScaleRange = Value<[Double]>.testConstantValue()
        ...
        do {
            ...
            XCTAssertEqual(layer.iconSizeScaleRange, Value<[Double]>.testConstantValue())
            ...
            XCTAssertEqual(layer.symbolElevationReference, Value<SymbolElevationReference>.testConstantValue())
            ...
            XCTAssertEqual(layer.textSizeScaleRange, Value<[Double]>.testConstantValue())
    ...
    func testEncodingAndDecodingOfPaintProperties() {
       ...
       do {
           ...
           XCTAssertEqual(layer.iconColorBrightnessMax, Value<Double>.testConstantValue())
           XCTAssertEqual(layer.iconColorBrightnessMin, Value<Double>.testConstantValue())
           XCTAssertEqual(layer.iconColorContrast, Value<Double>.testConstantValue())
           ...
           XCTAssertEqual(layer.occlusionOpacityMode, Value<OcclusionOpacityMode>.testConstantValue())
           XCTAssertEqual(layer.symbolZOffset, Value<Double>.testConstantValue())
    ...
    func testSetPropertyValueWithFunction() {
        let layer = SymbolLayer(id: "test-id", source: "source")
            ...
            .iconSizeScaleRange(min: 0, max: 1)
            ...
            .symbolElevationReference(SymbolElevationReference.testConstantValue())
            ...
            .textSizeScaleRange(min: 0, max: 1)
            ...
            .iconColorBrightnessMax(Double.testConstantValue())
            .iconColorBrightnessMin(Double.testConstantValue())
            .iconColorContrast(Double.testConstantValue())
            ...
            .occlusionOpacityMode(OcclusionOpacityMode.testConstantValue())
            .symbolZOffset(Double.testConstantValue())
        ...
        XCTAssertEqual(layer.iconSizeScaleRange, Value.constant([0, 1]))
        ...
        XCTAssertEqual(layer.symbolElevationReference, Value.constant(SymbolElevationReference.testConstantValue()))
        ...
        XCTAssertEqual(layer.textSizeScaleRange, Value.constant([0, 1]))
        ...
        XCTAssertEqual(layer.iconColorBrightnessMax, Value.constant(Double.testConstantValue()))
        XCTAssertEqual(layer.iconColorBrightnessMin, Value.constant(Double.testConstantValue()))
        XCTAssertEqual(layer.iconColorContrast, Value.constant(Double.testConstantValue()))
        ...
        XCTAssertEqual(layer.occlusionOpacityMode, Value.constant(OcclusionOpacityMode.testConstantValue()))
        XCTAssertEqual(layer.symbolZOffset, Value.constant(Double.testConstantValue()))
