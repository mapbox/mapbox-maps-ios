...
final class VectorSourceTests: XCTestCase {
    ...
    func testEncodingAndDecoding() {
        ...
        do {
            ...
            XCTAssert(decodedSource.extra_bounds == [[Double]].testSourceValue())
    ...
    func testSetPropertyValueWithFunction() {
        let source = VectorSource(id: "test-source")
            ...
            .extra_bounds([[Double]].testSourceValue())
        ...
        XCTAssertEqual(source.extra_bounds, [[Double]].testSourceValue())
