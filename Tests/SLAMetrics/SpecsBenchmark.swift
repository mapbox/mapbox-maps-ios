...
extension SpecsBenchmark {
    func runScenarioBenchmark(name: String,
        ...
        let bundle = try Bundle.testSpecifications
...
extension Bundle {
    static var testSpecifications: Bundle {
        get throws {
            let bundleURL = try XCTUnwrap(Bundle.main.url(forResource: "TestSpecifications", withExtension: "bundle"))
