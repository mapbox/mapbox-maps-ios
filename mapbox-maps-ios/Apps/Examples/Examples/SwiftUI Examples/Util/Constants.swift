...
extension CLLocationCoordinate2D {
    ...
    static let saigon = LocationCoordinate2D(latitude: 10.823099, longitude: 106.629662)
    static let hanoi = LocationCoordinate2D(latitude: 21.027763, longitude: 105.834160)
    static let tokyo = LocationCoordinate2D(latitude: 35.689487, longitude: 139.691711)
    static let bangkok = LocationCoordinate2D(latitude: 13.756331, longitude: 100.501762)
    static let jakarta = LocationCoordinate2D(latitude: -6.175110, longitude: 106.865036)
