...
final class StyleTests: XCTestCase {
    ...
    func testSet3DLights() throws {
        ...
        XCTAssertNoThrow(try style.set3DLights([ambientLight, directionalLight]))
        ...
        XCTAssertThrowsError(try style.set3DLights([ambientLight, directionalLight]))
    }
    ...
    func testSet3DLightProperty() throws {
        ...
        XCTAssertNoThrow(try style.set3DLightProperty(id: id, property: property, value: value))
        ...
        XCTAssertThrowsError(try style.set3DLightProperty(id: id, property: property, value: value))
    }
    ...
    func testGet3DLightProperty() throws {
        ...
        let propertyValue = style.get3DLightProperty(id: id, property: property)
