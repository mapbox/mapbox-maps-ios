...
main() {
    ...
    do
        ...
        xcodebuild clean build -workspace "$WORKSPACE_PATH" -scheme "$scheme" -destination 'platform=iOS Simulator,name=iPhone 13' CODE_SIGNING_ALLOWED='NO' &> "$ARTIFACTS_ROOT/${scheme}_xcode.log"
