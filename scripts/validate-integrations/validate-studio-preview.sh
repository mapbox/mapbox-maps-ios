...
git clone "https://x-access-token:$(mbx-ci github reader private token)@github.com/mapbox/studio-preview-ios.git" \
...
time xcodebuild clean build -workspace StudioPreview.xcworkspace \
